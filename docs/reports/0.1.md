...
Inventory:
[`compatibility/inventory/redland-1.0.17-oxiland-0.1.json`](https://github.com/eddiethedean/oxiland/blob/main/compatibility/inventory/redland-1.0.17-oxiland-0.1.json)  
...
stable durable storage and transaction matrix (0.4), utility/stream completion
(0.5), complete inventory accounting (0.6), and C ABI (0.7+).

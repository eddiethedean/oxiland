...
Status: planned; design work is next  
...
Release evidence: `docs/reports/0.2.md` when the milestone closes
...
The existing `oxiland::io` primitive re-exports remain available during design,
but they are not evidence for the 0.2 Redland-shaped facade.

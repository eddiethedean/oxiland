...
- SPARQL solution/triple iterators keep a cloned `Model` (shared store handle)
  and extend the Oxigraph iterator lifetime for the Python object; dropping the
  iterator releases both.

...
ALLOWED_IGNORES = frozenset({"RUSTSEC-2026-0194", "RUSTSEC-2026-0195"})
...
def main() -> int:
    ...
    print(
        "Verified narrow R-020 tip exception: Oxigraph 0.5.9 -> quick-xml "
        f"0.37.5; allowed ignores={sorted(ALLOWED_IGNORES)}; "
